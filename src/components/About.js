            ...
            <div className="flex flex-col gap-3">
                <div>
                    <p className="flex-1">
                        ...
                        esteemed organizations, including an Australian unicorn
                        start-up, a London EdTech start-up, and within the
                        Australian and UK education systems, I bring a wealth of
                        expertise to the table.
                        <br />
                        <br />
                        My forte lies in teamwork, effective communication, and
                        unwavering attention to detail, ensuring high-quality
                        project delivery. As a quick learner, I continuously
                        adapt to new challenges.
                        <br />
                        <br />
                        If you're seeking a dedicated professional who excels in
                        collaboration and possesses a keen eye for detail, let's
